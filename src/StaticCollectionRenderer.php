 ...
 * @internal
 */
final class StaticCollectionRenderer
{
    public static function render(TransientCollection $collector): string
    {
        ...
        \olvlvl\ComposerAttributeCollector\Attributes::with(fn () => new \olvlvl\ComposerAttributeCollector\StaticCollection(
     ...
     *     where `0` is the serialized arguments and `1` is the target class.
     */
