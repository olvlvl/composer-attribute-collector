...
final class Plugin implements PluginInterface, EventSubscriberInterface
{
     ...
     */
    private static function collectAttributes(array $classMap, IOInterface $io): Collection
    {
    ...
    public static function render(Collection $collection): string
    {
        $code = var_export($collection, true);
        ...
        olvlvl\ComposerAttributeCollector\Attributes::with(fn () => $code);
        PHP;
    }
