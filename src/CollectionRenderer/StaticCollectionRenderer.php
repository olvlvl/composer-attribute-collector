 ...
 * @internal
 */
final class StaticCollectionRenderer implements CollectionRenderer
{
    public static function render(TransientCollection $collector): string
    {
        ...
        \olvlvl\ComposerAttributeCollector\Attributes::with(fn () => new \olvlvl\ComposerAttributeCollector\Collection\StaticCollection(
        ...
        foreach ($arguments as $argument) {
            if ($argument instanceof \Closure) {
                throw new \InvalidArgumentException(
                    "PHP 8.5 Closures in constant expressions are not supported by the 'static' strategy, use 'reference' instead." .
