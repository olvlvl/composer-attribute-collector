 ...
 * @internal
 */
final class EmbeddedCollectionRenderer implements CollectionRenderer
{
    public static function render(TransientCollection $collector): string
    {
        ...
        \olvlvl\ComposerAttributeCollector\Attributes::with(fn () => new \olvlvl\ComposerAttributeCollector\Collection\EmbeddedCollection(
     ...
     *     where `0` are the attribute arguments and `1` is the target class.
     */
        ...
        foreach ($arguments as $argument) {
            if ($argument instanceof \Closure) {
                throw new \InvalidArgumentException(
                    "PHP 8.5 Closures in constant expressions are not supported by the 'embedded' strategy, use 'reference' instead." .
